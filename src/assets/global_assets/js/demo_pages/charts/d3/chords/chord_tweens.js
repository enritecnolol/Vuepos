                ...
                self.render = function() {
                    ...
                    svg.append("g")
                        ...
                        .append("path")
                            .attr("class", "d3-arc")
                            .attr("d", arc_svg)
                            .style("fill", function(d) { return fill(d.Customers); })
                            .style("stroke", function(d) { return fill(d.Customers); })
                    ...
                    svg.append("g")
                        ...
                        .enter()
                        .append("path")
                            .style("fill", function(d) { return fill(d.target.Customers); })
                            .attr("d", chord_svg)
                            .style("stroke", "#000")
            ...
            function fade(opacity, svg) {
              return function(g, i) {
                svg.selectAll(".d3-chord path")
                    .filter(function(d) {
                        return d.source.Customers != i && d.target.Customers != i;
                    })
                    .transition()
